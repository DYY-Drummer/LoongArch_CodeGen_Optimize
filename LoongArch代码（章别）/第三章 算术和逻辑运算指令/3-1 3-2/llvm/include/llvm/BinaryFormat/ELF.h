...
enum {
  ...
  EM_LOONGARCH = 999,          // Document LLVM Backend Tutorial LoongArch
};
...
enum {
    EF_LOONGARCH_NOREORDER = 0x00000001, // Don't reorder instructions
    EF_LOONGARCH_PIC = 0x00000002, // Position independent code
    EF_LOONGARCH_ARCH_32 = 0x50000000, // LOONGARCH32 instruction set per linux not elf.h
    EF_LOONGARCH_ARCH = 0xf0000000 // Mask for applying EF_LOONGARCH_ARCH_ variant
};
