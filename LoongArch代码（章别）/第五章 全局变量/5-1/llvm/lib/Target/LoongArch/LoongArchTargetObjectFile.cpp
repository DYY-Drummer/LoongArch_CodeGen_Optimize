...
static cl::opt<unsigned>
        SSThreshold("loongarch-ssection-threshold", cl::Hidden,
...
void LoongArchTargetObjectFile::Initialize(MCContext &Ctx, const TargetMachine &TM){
    ...
    this->TM = &static_cast<const LoongArchTargetMachine &>(TM);
}
...
bool LoongArchTargetObjectFile::
...
IsGlobalInSmallSectionImpl(const GlobalObject *GO,
    ...
    const LoongArchSubtarget &Subtarget =
            *static_cast<const LoongArchTargetMachine &>(TM).getSubtargetImpl();
...
MCSection *LoongArchTargetObjectFile::
