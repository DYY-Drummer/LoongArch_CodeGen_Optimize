...
// This will always be emitted whether we enable long branch pass or not.
// and will make llc fail at llvm_unreachable("unknown operand type");
// in LoongArchMCInstLower::LowerOperand
