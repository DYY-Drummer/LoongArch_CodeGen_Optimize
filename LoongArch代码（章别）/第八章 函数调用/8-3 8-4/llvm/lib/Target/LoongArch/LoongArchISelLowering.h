...
namespace llvm {
    namespace LoongArchISD {
        enum NodeType {
            ...
            Wrapper,
            DynAlloc,
            // Global Offset Table access instruction - la.got
            LA_GOT,
...
//===----------------------------------------------------------------------===//
    ...
    protected:
        ...
        public:
            ...
            unsigned regSize() const { return IsILP32S ? 4 : 4; }
        ...
        LoongArchCC::SpecialCallingConvType getSpecialCallingConv(SDValue Callee) const;
        ...
        isEligibleForTailCallOptimization(const LoongArchCC &LoongArchCCInfo,
                                          ...
                                          const LoongArchMachineFunctionInfo& FI) const = 0;
